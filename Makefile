main:
	...
	g++ -c main.cpp mmio.c -fopenmp -O3 -std=c++17 -lcudart
...
mpi:
	...
	echo "Gpu Sparse Approximation object.. OK"
	g++ -c main.cpp mmio.c -fopenmp -O3 -std=c++17 -lcudart -DMPIENABLED
	echo "Main cpp object.. OK"
...
debug:
	...
	g++ -c main.cpp mmio.c -fopenmp -O3 -std=c++17 -lcudart -g -DDEBUG
...
cpu:
	g++ -o cpu_perman main.cpp mmio.c -fopenmp -O3 -std=c++17 -DONLYCPU

avx:
	g++ -o cpu_avx_perman main.cpp mmio.c -fopenmp -O3 -std=c++17 -march=skylake-avx512 -mtune=skylake-avx512 -DONLYCPU -DAVX

avxgdb:
	g++ -o cpu_avx_perman main.cpp mmio.c -fopenmp -O3 -std=c++17 -march=skylake-avx512 -DONLYCPU -DAVX -D_GLIBCXX_DEBUG -g 
...
#	echo "Gpu Sparse Approximation object.. OK"
#	clang++-12fpchecker -c main.cpp mmio.c -fopenmp -O3 -std=c++17 -lcudart
#	echo "Main cpp object.. OK"
...
#fpcpu:
#	clang++-12fpchecker -o fpc_perman main.cpp mmio.c -fopenmp -O3 -std=c++17 -DONLYCPU=\"ONLYCPU\"
